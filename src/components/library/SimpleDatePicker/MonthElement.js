...
function MonthElement(props) {
	...
	return (
		<select id="date-month" onClick={props.validateMonth} onChange={(e)=>{props.onChangeMonth({month : Number(e.target.value)})}} value={props.selectedMonth} style={props.styleObj}>{

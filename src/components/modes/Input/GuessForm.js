				...
				<div className="guess-form panel">
					...
					<div className="inputs flex-item">
						...
						<div className="input-wrapper"><p>Gender</p>
							<LockIcon display={!this.helpers.isGuessable('gender') ? 'lavendar' : 'off'}/>
						...
						<LockIcon display={!this.helpers.isGuessable('weight') ? 'lavendar' : 'off'}/>
							...
							<input id="weight" name="weight" type="range" min="80" max="224" step="1" value={this.state.birthGuess.weight} onChange={this.handlers.onChange.field} disabled={!this.helpers.isGuessable('weight')} />
							</Validation>
							</div>
							{/* Date */}
